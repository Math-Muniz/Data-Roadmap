...
<p>Linhas duplicadas são linhas que foram registradas mais de uma vez.</p>
<pre>
   Duration          Date  Pulse  Maxpulse  Calories
0         60  '2020/12/01'    110       130     409.1
1         60  '2020/12/02'    117       145     479.0
...
<p>Ao analisar nosso conjunto de dados de teste, podemos supor que as linhas 11 e 12 são duplicatas.</p>
<p>Para descobrir duplicatas, podemos usar o método duplicated().</p>
<p>O método duplicated() retorna um valor booleano para cada linha:</p>
<p><b>Exemplo:</b></p>
<p>Abaixo vamos fazer retornar True para cada linha que é uma duplicata, caso contrário, vai retornar False:</p>
<pre>
print(df.duplicated())
</pre>
<h2 align="center">Removendo Dados Duplicados</h2>
<p>Para remover duplicatas, use o método drop_duplicates().</p>
<p><b>Exemplo:</b></p>
<p>Remova todos os dados duplicados:</p>
<pre>
df.drop_duplicates(inplace = True)
</pre>
<p><b>Lembre-se:</b> O argumento (inplace = True) garantirá que o método NÃO retorne um novo DataFrame, mas removerá todas as duplicatas do DataFrame original.</p>
